...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('files_widget_iconset', (
        ...
        db.send_create_signal('files_widget', ['IconSet'])

        # Adding model 'FileIcon'
        db.create_table('files_widget_fileicon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('files_widget', ['FileIcon'])


    def backwards(self, orm):
        # Deleting model 'IconSet'
        db.delete_table('files_widget_iconset')

        # Deleting model 'FileIcon'
        db.delete_table('files_widget_fileicon')


    models = {
        'files_widget.fileicon': {
            ...
            'icon_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['files_widget.IconSet']"}),
        ...
        'files_widget.iconset': {
            'Meta': {'object_name': 'IconSet'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'css_path': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'default_icon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['files_widget.FileIcon']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
